...
#ifndef CYBERDOG_UTILS__CAN__VISIBILITY_CONTROL_HPP_
#define CYBERDOG_UTILS__CAN__VISIBILITY_CONTROL_HPP_
...
#endif  // CYBERDOG_UTILS__CAN__VISIBILITY_CONTROL_HPP_
