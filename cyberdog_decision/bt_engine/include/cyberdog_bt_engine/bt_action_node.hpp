...
#ifndef CYBERDOG_BT_ENGINE__BT_ACTION_NODE_HPP_
#define CYBERDOG_BT_ENGINE__BT_ACTION_NODE_HPP_
...
public:
  /**
   * @brief A cyberdog_decision::BtActionNode constructor
...
#endif  // CYBERDOG_BT_ENGINE__BT_ACTION_NODE_HPP_
