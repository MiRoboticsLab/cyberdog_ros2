...
#ifndef CYBERDOG_BT_ENGINE__ROS_TOPIC_LOGGER_HPP_
#define CYBERDOG_BT_ENGINE__ROS_TOPIC_LOGGER_HPP_
...
#include "motion_msgs/msg/behavior_tree_log.hpp"
#include "motion_msgs/msg/behavior_tree_status_change.h"
...
public:
  /**
   * @brief A constructor for cyberdog_decision::RosTopicLogger
  ...
  : StatusChangeLogger(tree.rootNode())
  {
    ...
    log_pub_ = node->create_publisher<motion_msgs::msg::BehaviorTreeLog>(
      "behavior_tree_log",
      rclcpp::QoS(10));
  }
  ...
  {
    motion_msgs::msg::BehaviorTreeStatusChange event;
  ...
  {
    if (!event_log_.empty()) {
      auto log_msg = std::make_unique<motion_msgs::msg::BehaviorTreeLog>();
...
protected:
  ...
  rclcpp::Publisher<motion_msgs::msg::BehaviorTreeLog>::SharedPtr log_pub_;
  std::vector<motion_msgs::msg::BehaviorTreeStatusChange> event_log_;
};

}   // namespace cyberdog_decision

#endif   // CYBERDOG_BT_ENGINE__ROS_TOPIC_LOGGER_HPP_
