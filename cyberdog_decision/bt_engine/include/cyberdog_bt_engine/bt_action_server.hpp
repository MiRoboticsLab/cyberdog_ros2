...
#ifndef CYBERDOG_BT_ENGINE__BT_ACTION_SERVER_HPP_
#define CYBERDOG_BT_ENGINE__BT_ACTION_SERVER_HPP_
...
#include "cyberdog_bt_engine/ros_topic_logger.hpp"
#include "cyberdog_bt_engine/bt_engine.hpp"
...
{
/**
 * @class cyberdog_decision::BtActionServer
...
public:
  ...
  /**
   * @brief A constructor for cyberdog_decision::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for cyberdog_decision::BtActionServer class
   */
  ~BtActionServer() {}
    ...
    std::chrono::milliseconds bt_action_server_timeout = std::chrono::milliseconds(20))
  {
    ...
    bt_ = std::make_unique<cyberdog_decision::BehaviorTreeEngine>(plugin_lib_names_);
...
protected:
  ...
  void executeCallback()
  {
    ...
    cyberdog_decision::BtStatus rc = bt_->run(&tree_, on_loop, is_canceling, bt_loop_duration_);
...
private:
  ...
  std::unique_ptr<cyberdog_decision::BehaviorTreeEngine> bt_;
...
#endif  // CYBERDOG_BT_ENGINE__BT_ACTION_SERVER_HPP_
