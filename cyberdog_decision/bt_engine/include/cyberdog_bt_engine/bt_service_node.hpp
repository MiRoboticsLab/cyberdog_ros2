...
#ifndef CYBERDOG_BT_ENGINE__BT_SERVICE_NODE_HPP_
#define CYBERDOG_BT_ENGINE__BT_SERVICE_NODE_HPP_
...
public:
  /**
   * @brief A cyberdog_decision::BtServiceNode constructor
...
#endif  // CYBERDOG_BT_ENGINE__BT_SERVICE_NODE_HPP_
