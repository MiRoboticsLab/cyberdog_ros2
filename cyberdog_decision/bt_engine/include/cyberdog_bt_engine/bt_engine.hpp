...
#ifndef CYBERDOG_BT_ENGINE__BT_ENGINE_HPP_
#define CYBERDOG_BT_ENGINE__BT_ENGINE_HPP_
...
public:
  /**
   * @brief A constructor for cyberdog_decision::BehaviorTreeEngine
   ...
   * @return cyberdog_decision::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
...
#endif  // CYBERDOG_BT_ENGINE__BT_ENGINE_HPP_
