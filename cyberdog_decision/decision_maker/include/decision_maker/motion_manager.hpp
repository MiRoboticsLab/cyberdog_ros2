...
#ifndef DECISION_MAKER__MOTION_MANAGER_HPP_
#define DECISION_MAKER__MOTION_MANAGER_HPP_
...
class MotionManager : public cyberdog_decision::CascadeManager
{
public:
  MotionManager();
  ~MotionManager();
...
// Node individual
  std::shared_ptr<cyberdog_decision::AutomationManager> automation_manager_node_;
...
#endif  // DECISION_MAKER__MOTION_MANAGER_HPP_
