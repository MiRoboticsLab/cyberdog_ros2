...
#ifndef MANAGER_UTILS__BT_ACTION_NODE_HPP_
#define MANAGER_UTILS__BT_ACTION_NODE_HPP_
...
public:
  /**
   * @brief A bt_engine::BtActionNode constructor
...
#endif  // MANAGER_UTILS__BT_ACTION_NODE_HPP_
