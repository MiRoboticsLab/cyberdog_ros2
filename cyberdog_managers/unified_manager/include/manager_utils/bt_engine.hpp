...
#ifndef MANAGER_UTILS__BT_ENGINE_HPP_
#define MANAGER_UTILS__BT_ENGINE_HPP_
...
public:
  /**
   * @brief A constructor for bt_engine::BehaviorTreeEngine
   ...
   * @return bt_engine::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
...
#endif  // MANAGER_UTILS__BT_ENGINE_HPP_
