...
#ifndef MANAGER_UTILS__BT_SERVICE_NODE_HPP_
#define MANAGER_UTILS__BT_SERVICE_NODE_HPP_
...
public:
  /**
   * @brief A bt_engine::BtServiceNode constructor
...
#endif  // MANAGER_UTILS__BT_SERVICE_NODE_HPP_
