...
#ifndef MANAGER_UTILS__ROS_TOPIC_LOGGER_HPP_
#define MANAGER_UTILS__ROS_TOPIC_LOGGER_HPP_
...
public:
  /**
   * @brief A constructor for bt_engine::RosTopicLogger
...
#endif   // MANAGER_UTILS__ROS_TOPIC_LOGGER_HPP_
